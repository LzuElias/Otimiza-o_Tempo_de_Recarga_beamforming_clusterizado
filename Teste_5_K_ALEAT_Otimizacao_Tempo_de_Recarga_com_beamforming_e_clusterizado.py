...
Set_x_disp = np.random.uniform(x_min, x_max, [N_set_disp,6*K])
Set_y_disp = np.random.uniform(y_min, y_max, [N_set_disp,6*K])
...
eixo_x_2 = np.delete(eixo_x, 0)


plt.figure(figsize=(8, 6))
plt.plot(eixo_x_2, tempo, marker='o', linestyle='-', color='b', label='Tempo Médio de Carregamento')
